        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (!options['type']) {
                if (this.env.flags.interactive) {
                    this.env.log.info(`You are about to create an Ionic 3 app. Would you like to try the release candidate for Ionic 4?\n` +
                        ...
                        `${chalk_1.default.cyan('[1]')}: ${chalk_1.default.bold('https://blog.ionicframework.com/ionic-framework-4-0-rc-shipped-paving-way-for-final')}\n` +
    ...
    showNextSteps(projectDir, cloned, linkConfirmed) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const steps = [
                ...
                `Build features and components: ${chalk_1.default.bold('https://beta.ionicframework.com/docs/building/scaffolding')}`,
                `Get Ionic DevApp for easy device testing: ${chalk_1.default.bold('https://bit.ly/ionic-dev-app')}`,
            ];
            if (linkConfirmed) {
                steps.push(`Finish setting up Ionic Appflow Error Monitoring: ${chalk_1.default.bold('https://ionicframework.com/docs/appflow/monitoring/#getting-started')}`);
                steps.push(`Finally, push your code to Ionic Appflow to perform real-time updates, and more: ${chalk_1.default.green('git push ionic master')}`);
            }
