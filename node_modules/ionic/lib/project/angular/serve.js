...
The dev server can use HTTPS via the ${chalk_1.default.green('--ssl')} option ${chalk_1.default.bold.red('(experimental)')}. There are several known issues with HTTPS. See issue #3305${chalk_1.default.cyan('[2]')}.

${chalk_1.default.cyan('[1]')}: ${chalk_1.default.bold('https://angular.io/cli/serve')}
${chalk_1.default.cyan('[2]')}: ${chalk_1.default.bold('https://github.com/ionic-team/ionic-cli/issues/3305')}`,
                options: [
                    {
                        name: 'ssl',
...
class AngularServeCLI extends serve_1.ServeCLI {
    ...
    serveOptionsToNgArgs(options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return [...cli_framework_1.unparseArgs(args), ...separatedArgs];
        });
    }
